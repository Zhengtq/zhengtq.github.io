...
def _load_batch_filename(input_queue, original_img_shape, channels, batch_size, all_image_num, to_height=224, to_width=224,img_norm=True, resize_type = 0):
	...
	for _ in range(preprocess_threads):
		...
		images_and_labels_list.append([images, image_depths, label])
	...
	label_batch = tf.identity(label_batch, 'label_batch')
    	...
    	return img_batch, img_depth_batch,label_batch
...
def _generate_list(img_roots_txt, batch_size, epoc_size):
	...
	input_queue = data_flow_ops.FIFOQueue(capacity=3500000,
	...
	return input_queue, enqueue_op, img_root_list, label_list, index_dequeue_op, image_paths_placeholder, labels_placeholder
